...
- Define and document the `Props` interface in frontmatter so every reusable component clearly describes its public contract.
- Use comments to explain intent or non-obvious decisions, not to paraphrase the markup or script.
